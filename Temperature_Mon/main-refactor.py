#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""This is version 3 of the 1wire(spi) program.
This version introduces refactoring for a more functional style
...
def send_to_thingspeak(data):
    ...
    for channel in channel_list:
        ...
        for _idx, device_dict in enumerate(channel):
            field_tag = (
                f'&field{device_dict["THINGSPEAK_Field"]}={device_dict["Farenheiht"]}'
            )
